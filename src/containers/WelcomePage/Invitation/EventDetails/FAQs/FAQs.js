    ...
    render() {
        return (
            <div className="faqs">
                ...
                {this.accordion("What's the weather like?", <Aux><p>
                ...
                {this.accordion("How is Brexit affecting me?", <Aux><p>As the laws of travel to EU may change after 29 March in the event of no–deal, please check <b>your passports have more than 15 months validity left</b> on them before you travel.
</p><p>
                ...
                {this.accordion("Arriving by car? What's the law?", <Aux><p>France has some stricter driving laws than the UK, so if you are driving your own car over to France we advise you to look at the checklist to make sure you have the things in your car required by French law.
</p><p>
                ...
                {this.accordion("If I don't stay at the venue, how will I get back home after the celebration night?", <Aux><p>We will be organising a shuttle service to take guests within a maximum of a 30-minute drive back to their accommodations after the party has finished. If you would like to use this service, we kindly ask that guests contribute and bring euros to help towards the cost of this.
